package com.example.securechat.Notification;
...
public class OreoNotification extends ContextWrapper {
    private static final String CHANNEL_ID = "com.example.securechat";
    private static final String CHANNEL_NAME = "securechat";
