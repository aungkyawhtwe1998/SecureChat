...
public class FriendRequestAdapter extends RecyclerView.Adapter<FriendRequestAdapter.ViewHolder> {
    ...
    public FriendRequestAdapter(Context mContext, List<String> mfriend) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Log.i("Adapter", "onBindViewHolder:Request" + fuser);
        //friendb= FirebaseDatabase.getInstance().getReference("Friend_req").child(fuser);
